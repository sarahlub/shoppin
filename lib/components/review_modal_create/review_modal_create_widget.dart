                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'u6odh1by' /* Please fill out the informatio... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                      ),
                        ...
                        Align(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'cs18z7tu' /* Please select a rating from ab... */,
                            ),
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'dd62kjui' /* Please submit a rating above. */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
