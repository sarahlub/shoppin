                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKeIlRD1X0sr8l3uqjvruHCm8hTFlFIlSLsw&usqp=CAU',
                                            width: 80.0,
                                            height: 80.0,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      children: [
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(6.0),
                                          child: Image.network(
                                            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtklfej5IFpe7HXsBmWj1TlDboITjaR_zieQ&usqp=CAU',
                                            width: 80.0,
                                            height: 80.0,
                                            fit: BoxFit.cover,
                                          ),
