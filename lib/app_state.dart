...
class FFAppState extends ChangeNotifier {
  ...
  List<ShippingOptionsStruct> _shippingOptions = [
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{"shippingName":"Express Delivery","description":"Get your shipment in 1 business days","price":"3500"}')),
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{"shippingName":"Standard Delivery","description":"Get your shipment in 2-3 business days","price":"2000"}')),
    ShippingOptionsStruct.fromSerializableMap(jsonDecode(
        '{"shippingName":"Free Delivery","description":"Get your no rush option for recieving your package in 3 business days.","price":"0"}'))
  ];
