                                        ...
                                        children: [
                                            ...
                                            children: [
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'jbot5vzt' /* Enter your information */,
                                                ),
                                                style:
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '57hhgx1c' /* Below is the list of items in ... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium,
                                                          ...
                                                          collapsed: Container(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'm9501nv5' /* Please select a delivery optio... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelMedium,
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'd58pmlsg' /* Please enter the information b... */,
                                                                ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: CheckboxListTile(
                                                                                ...
                                                                                subtitle: Text(
                                                                                  FFLocalizations.of(context).getText(
                                                                                    'yps1qu5y' /* Select next day or 2 day shipp... */,
                                                                                  ),
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ymj506cw' /* Below is a list of your items. */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium,
